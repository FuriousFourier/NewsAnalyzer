...
public class DbController {
	...
	@ResponseBody
    public synchronized boolean addSomething(@RequestParam("secNum") Long securityNumber) throws IOException {
    ...
    private static void extractFeedsFilesAndSaveNewWay(File file, boolean newFeeds) throws IOException {
    ...
    private static void addPressReleasesToDBNewWay(String path, boolean newFeeds) throws IOException {
	...
	public synchronized String getNewFeeds(@RequestParam("secNum") Long secNum){
		if (!secNum.equals(NewsAnalyzerMain.getSecurityNumber())) {
			return "myError";
		}
		...
		try {
			...
			addSomething(NewsAnalyzerMain.getSecurityNumber());
